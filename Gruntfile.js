        ...
        options: {
          ...
          middleware: function (connect) {
            return [
              ...
              // as in http://stackoverflow.com/a/24384293/1399395; npm install connect-modrewrite --save-dev
              ...
              connect().use(
                '/dist/scripts',
                serveStatic('./dist/scripts')
              ),
              connect().use(
                '/systemjs.config.js',
                serveStatic('./systemjs.config.js')
              ),
              connect().use(
                '/app/styles',
